...
def explainMessage(messageInput, prediction):
    ...
    if prediction.lower() == "spam":
        ...
        explanation = ("The phrases used such as "f"{', '.join(words)} are commonly used within malicious messages, indicating this is spam.")
        prediction = ("This message is likely spam")

    else:
        explanation = ("This message does not contain any phrases commonly used in spam messages, indicating it is likely a real message.")
        prediction = ("This message is likely safe")
